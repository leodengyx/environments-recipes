class env::big::packages () {
  ...
  if "${::lsbdistcodename}" == "stretch" {
    $general_dev = [ 'libreadline6-dev', 'autoconf', 'flex', 'bison', 'libyaml-0-2', 'cgdb', 'cmake', 'cmake-curses-gui', 'cvs', 'gdb', 'gfortran', 'git-core', 'subversion', 'libatlas-base-dev', 'libdate-calc-perl', 'libc6', 'libjson-perl', 'libjson-xs-perl', 'libssl-dev', 'make', 'patch', 'tcl', 'php-cli', 'valgrind', 'libtool', 'libnuma-dev', 'libdb-dev', 'libatlas-dev','debconf-utils', 'libnetcdf-dev', 'libboost-all-dev' ]
    $java_dev = [ 'openjdk-8-jdk', 'openjdk-8-jre', 'ant' ]
  } else {
